...
function SimpleTelegram() {
  ...
  var addNumber = function(number, firstName, lastName, logLevel){
    if(!number) return
    if(!telegramProcess) return
    var level = (logLevel | 'info')
    log(level, 'Me >>> ' + number + " : " + firstName + "_" + lastName + "\n", encoding='utf8')
    telegramProcess.stdin.write('add_contact ' + number + ' ' + firstName + ' ' + lastName + '\n', encoding='utf8')
  }
